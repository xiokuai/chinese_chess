...
class Chess:
    ...
    def highlight(
        self, condition: bool, color: str | None = None, inside: bool = True
    ) -> bool:
        from GUI import Window
